...
* If you don't have nsenter/docker-enter, you can mount the data container and modify it with
        ...
        docker run --rm -it --volumes-from $OVPN_DATA farfeduc/openvpn bash -l
...
1. Get the container's name or container ID:
        ...
        ed335aaa9b82        farfeduc/openvpn:latest   ovpn_run            5 minutes ago       Up 5 minutes        0.0.0.0:1194->1194/udp   sad_lovelace
